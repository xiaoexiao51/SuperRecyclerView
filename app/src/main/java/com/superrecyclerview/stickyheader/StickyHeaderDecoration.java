    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (!mIncludeHeader) {
            if (parent.getAdapter() instanceof LRecyclerViewAdapter) {
                int headerCount = ((LRecyclerViewAdapter) parent.getAdapter()).getHeaderViewsCount() + 1;
                int footerCount = ((LRecyclerViewAdapter) parent.getAdapter()).getFooterViewsCount();
                int dataCount = ((LRecyclerViewAdapter) parent.getAdapter()).getItemCount();
