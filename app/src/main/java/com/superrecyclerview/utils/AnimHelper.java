...
public final class AnimHelper {
    ...
    public static void doHeartBeat(View view, int duration) {
        ...
        set.playTogether(
                ObjectAnimator.ofFloat(view, "scaleX", 2.0f, 1.0f, 2.0f, 3.0f),
                ObjectAnimator.ofFloat(view, "scaleY", 2.0f, 1.0f, 2.0f, 3.0f),
                ObjectAnimator.ofFloat(view, "alpha", 1.0f, 0.8f, 0.8f, 0.0f));
