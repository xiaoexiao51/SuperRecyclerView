...
import com.superrecyclerview.interfaces.AppBarStateListener;
 ...
 * 仿IOS侧滑Item删除菜单 http://blog.csdn.net/jdsjlzx/article/…
 */
public class LRecyclerView extends RecyclerView {
    ...
    private AppBarStateListener.State appbarState = AppBarStateListener.State.EXPANDED;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mLastY = ev.getRawY();
                sumOffSet += deltaY;
                if (isOnTop() && mRefreshEnabled && !mRefreshing && (appbarState == AppBarStateListener.State.EXPANDED)) {
            ...
            default:
                mLastY = -1; // reset
                if (isOnTop() && mRefreshEnabled && !mRefreshing/*&& appbarState == AppBarStateChangeListener.State.EXPANDED*/) {
    ...
    public boolean isOnTop() {
        return mRefreshEnabled && (mRefreshHeader.getHeaderView().getParent() != null);
    }
